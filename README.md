...
- `TVFileBox-v1.2.0-armeabi-v7a.apk`: 32-bit ARM TV boxes.
- `TVFileBox-v1.2.0-arm64-v8a.apk`: 64-bit ARM devices.
- `TVFileBox-v1.2.0-universal.apk`: universal build for general installation.
